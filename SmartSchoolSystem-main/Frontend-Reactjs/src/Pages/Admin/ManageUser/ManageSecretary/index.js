...
import { Home as HomeIcon, Person, Edit, Delete, PersonAdd } from '@mui/icons-material';
                        ...
                        <Grid container>
                            <Grid item xs={ 12 } sx={ { backgroundColor: '#9e9e9e5c', p: 1 } }>
                                <Grid container display='flex' alignItems='center'>
                                    <Grid item xs={ 11 }>
                                        <Typography variant="subtitle1">Secretaries</Typography>
                                    </Grid>
...
function IconBreadcrumbs ()
{
    return (
        <Breadcrumbs aria-label="breadcrumb" justifyContent='center' alignItems='center'>
            ...
            <Typography
                sx={ { display: 'flex', alignItems: 'center', fontWeight: 'bold', fontSize: '0.9rem' } }
                color="text.primary"
            >
...
function GridData ( props )
{
    ...
    const { isLoading, data , refetch} = useQuery( 'getAllSecretary', async () =>
    {
        return axios.get( 'http://localhost:8000/api/getAllSecretary');
    },
    {
        refetchOnMount: true
    }
    ...
    const editParent = React.useCallback((params)=>()=>{
        navigate("./editSecretary/"+params.id)
    })
      ...
      <>
        ...
        >
          <DialogTitle id="alert-dialog-title">
            <Typography variant="h5">Delete secretary</Typography>
          </DialogTitle>
          <DialogContent>
            <DialogContentText
              ...
              variant="subtitle1"
            >
              Are you sure to delete secretary?
            </DialogContentText>
          </DialogContent>
          <DialogActions>
