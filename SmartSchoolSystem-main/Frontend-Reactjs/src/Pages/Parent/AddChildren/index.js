...
function AddChildren() {
  ...
  }, [firstname, lastname, email, classes, birthday, address]);
        ...
        setSuccess(
          ...
          >
            <Alert variant="filled" severity="error">
              ...
              Failed add —<strong>check it out!</strong>
            </Alert>
          </Snackbar>
        );
        setTimeout(() => {
  ...
  const { isLoading, error, data, refetch } = useQuery(
    ...
    async () => {
      ...
      fdata.append("id_parent", parent.id);
      fdata.append("isValidate", 0);
          ...
          <MainCard sx={{ width: "100%", height: "100%" }}>
            <Grid container>
              <Grid item xs={12} mb={1} display="flex" justifyContent="center">
                <Typography variant="h3">Add New Children</Typography>
              </Grid>
