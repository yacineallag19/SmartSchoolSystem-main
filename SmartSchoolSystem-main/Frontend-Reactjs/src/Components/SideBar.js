    ...
    return (
        <>
            <Drawer variant='permanent' open={ props.open }>
                ...
                <Divider />
                <Stack spacing={ 0.5 }>
                    <Typography variant='subtitle1' sx={ { transform: 'translateX(10px)' } }>{ props.open ? 'Application' : 'App' }</Typography>
                    <MenuList list={ props.listApp } drawerOpen={ props.open } />
                </Stack>
                <Divider />
                <Stack spacing={ 1 } >
                    <Typography variant='subtitle1' sx={ { transform: 'translateX(10px)' } }>Other</Typography>
                    <MenuList list={ props.listOther } drawerOpen={ props.open } />
                </Stack>
